package org.java_juc.begginer_level.future_cf_executor_service_16.fc_supplyrun_thenaccept.multi_thread_executor;

import java.util.concurrent.ExecutionException;

public class Main {
    public static void main(String[] args) {
        UserServiceMultiThreadExecutor userServiceMultiThreadExecutor = new UserServiceMultiThreadExecutor();
        try {
            userServiceMultiThreadExecutor.sendNotification().get();
...
/*
Thread getAllUsers : pool-1-thread-1
Thread filters Female : pool-1-thread-2
Thread filters Salary greater than 90000 : pool-1-thread-3
Thread extracts emails : pool-1-thread-4
Thread sends emails : pool-1-thread-5
