package org.java_juc.begginer_level.multi_thread_sync_lock_5.lock_issues.issue_4;
...
public class CommonIssues {
    public static void main(String[] args) throws InterruptedException {
        ...
        new Thread(phoneB::sendEmail, "Thread_2").start(); //  new Thread(()-> { phoneB.sendEmail();}, "Thread_2").start();
    }
}
