...
public class Main {
    public static void main(String[] args) {
        UserServiceMultiExecutors serviceMultiExecutors = new UserServiceMultiExecutors();
        try {
            serviceMultiExecutors.sendNotification().get();
...
Thread filters Female : pool-2-thread-1
Thread filters Salary greater than 90000 : pool-3-thread-1
Thread extracts emails : pool-1-thread-2
Thread sends emails : pool-1-thread-3
